"""
This is an early 2-D implementation of Tim Kittel's original Alpha Shapes
3-D implementation. You can see the original code at:

    > https://github.com/timkittel/alpha-shapes

The 2-D functionality has been contributed to PySAL and can now be found at:

    > https://github.com/pysal/pysal/blob/master/pysal/lib/cg/alpha_shapes.py

This file is provided as a reference for the analysis performed in this
repository. For future use, you are referred to the PySAL implementation
linked above

Copyright Dani Arribas-Bel 2019
"""
